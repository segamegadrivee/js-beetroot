...
let d = 9;
let cd = c / d;
document.querySelector(".out-2").innerHTML = cd;
...
let f = 5;
let ef = e +  f;
document.querySelector(".out-3").innerHTML = ef;
...
document.querySelector(".out-4").innerHTML = e1 + f1; // Різниця у тому що ми додаємо стрінги і в нас просто з'єднуються строки
...
function t9() {
    ...
    document.querySelector('.out-9').innerHTML = data9;
...
function t10() {
    ...
    document.querySelector('.out-10').innerHTML = data10 * 20;
...
function t13() {
    ...
    let i13_1 = parseInt(document.querySelector('.i-13-1').value);
    let i13_2 = parseInt(document.querySelector('.i-13-2').value);
    document.querySelector('.out-13').innerHTML = i13_1 + i13_2;
...
function t16() {
    let value1 = document.querySelector('.i-16-1').value;
    let value2 = document.querySelector('.i-16-2').value;
    document.querySelector('.out-16').innerHTML = +value1 + +value2;
...
function t18() {
    let b = parseInt(document.querySelector('.i-18').value) ;
...
function t19() {
    ...
    let i_19_2 = parseInt(document.querySelector('.i-19-2').value);
    document.querySelector('.out-19').innerHTML = i_19_1 + i_19_2;
}
